...
d = 1 : Dezimalzahl\;
d = $\sqrt[2]{(kante.A.x - kante.B.x)^2 + (kante.A.y - kante.B.y)^2}$\;
...
\end{algorithm}
Dieser Algorithmus ist das Iterative aufrufen und addieren der Ergebnisse der Funktion P, für jede Kante die von der momentanen Position ausgehen.\\\\
